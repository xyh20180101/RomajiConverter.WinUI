...
namespace RomajiConverter.WinUI.Helpers
{
    public static class VariantHelper
    {
        ...
        {
            _simplifiedVariant = GetVariantDictionary("Variants/kSimplifiedVariant.txt", "Variants/kTraditionalVariant.txt");
            _traditionalVariant = GetVariantDictionary("Variants/kTraditionalVariant.txt", "Variants/kSimplifiedVariant.txt");
        }
